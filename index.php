...
/**
 * @package     Joomla.Site
 * @subpackage  Templates.anezi_protostar
 *
...
<head>
	...
	<style type="text/css">
		...
		.navbar-inner, .nav-list > .active > a, .nav-list > .active > a:hover, .dropdown-menu li > a:hover, .dropdown-menu .active > a, .dropdown-menu .active > a:hover, .nav-pills > .active, .nav-pills > .active:hover,
		.btn-primary
		{
...
<?php if ($this->params->get('sitedescription')) { echo '<div class="site-description">'. htmlspecialchars($this->params->get('sitedescription')) .'</div>'; } ?>
	...
	<footer class="footer" role="contentinfo">
		<div class="container<?php echo ($params->get('fluidContainer') ? '-fluid' : '');?>">
			...
			<p class="pull-right"><a href="#top" id="back-top"><?php echo JText::_('TPL_ANEZI_PROTOSTAR_BACKTOTOP'); ?></a></p>
